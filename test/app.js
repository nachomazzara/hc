...
contract('CatalystApp', ([appManager, user]) => {
  let app
  ...
  beforeEach('deploy dao and app', async () => {
    ...
    const instanceReceipt = await dao.newAppInstance(
      hash('catalyst.aragonpm.test'), // appId - Unique identifier for each app installed in the DAO; can be any bytes32 string in the tests.
